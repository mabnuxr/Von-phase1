 ...
 */
const WidgetShell: React.FC<WidgetShellProps> = ({ title, subtitle, children, onDrillDown }) => {
  return (
      ...
      <div className="relative flex items-center px-3 py-2.5 border-b border-gray-100 shrink-0">
        ...
        {onDrillDown && (
          <button
            ...
            className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center w-7 h-7 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-gray-700 cursor-pointer shrink-0 ml-2"
            title="View data"
          >
            <TableIcon size={14} />
          </button>
