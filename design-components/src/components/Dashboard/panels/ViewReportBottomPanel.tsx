...
import { dashboardFilterFields } from './dashboardFilterDefaults';
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute left-0 right-0 bottom-0 z-[101] bg-white rounded-xl border-t border-gray-200 shadow-xl flex flex-col overflow-hidden"
            style={{ top: 56 }}
          >
            {/* Panel header */}
