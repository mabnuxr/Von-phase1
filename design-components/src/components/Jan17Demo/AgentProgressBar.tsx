...
import { RobotIcon, SpinnerGapIcon, CheckCircleIcon } from '@phosphor-icons/react';
          ...
          <div className="h-full bg-white/95 backdrop-blur-sm border-b border-gray-200 flex items-center justify-between px-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                >
                  {status === 'complete' ? (
                    <CheckCircleIcon size={18} weight="fill" className="text-white" />
                  ) : (
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  {status === 'working' && (
                    ...
                    >
                      <SpinnerGapIcon size={14} weight="bold" className="text-purple-600" />
                    </motion.div>
                  )}
                </div>
