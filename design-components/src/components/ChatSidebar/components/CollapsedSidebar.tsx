...
export interface CollapsedSidebarProps {
  ...
  /** When false, the Folders icon (and its hover dropdown) is hidden.
   *  Defaults to true. */
    ...
    <div className="px-2 py-3 h-full w-full bg-white rounded-xl border border-gray-100 shadow-xs flex text-sm flex-col antialiased font-sf">
      ...
      <div className="flex-1">
        <div className="flex flex-col items-start gap-2">
          ...
          {/* Folders Icon with Hover Dropdown — gated by `enableFolders`
              so callers (e.g. View Only role) can suppress the feature. */}
          {enableFolders && (
          <div
            className="relative"
