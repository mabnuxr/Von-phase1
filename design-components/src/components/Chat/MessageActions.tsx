...
export const MessageActions: React.FC<MessageActionsProps> = ({
  ...
  const buttonClass =
    'p-1.5 rounded hover:bg-gray-100 text-gray-500 hover:text-gray-600 transition-colors cursor-pointer';
      ...
      {showTransparency && (
        <>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1 rounded hover:bg-gray-100 text-gray-500 hover:text-gray-600 transition-colors cursor-pointer text-sm"
            title="View sources"
