...
export const DatabaseIcon = memo<IconProps>(
...
export const ToolIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
...
export const CalculatorIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <path d="M8 6h8M8 10h8M8 14h8M8 18h8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
);
...
export const CheckCircleIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
...
export const XCircleIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
...
export const LoaderIcon = memo<IconProps>(
  ({ className = 'w-4 h-4 animate-spin', size = 16 }) => (
    <svg
      className={className}
      width={size}
      height={size}
...
export const ArrowDownIcon = memo<IconProps>(
...
export const TrendingUpIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
...
export const HashIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
...
export const DollarSignIcon = memo<IconProps>(
  ({ className = 'w-4 h-4', size = 16 }) => (
    <svg
      className={className}
      width={size}
