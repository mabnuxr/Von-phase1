...
export const StopIcon = memo<IconProps>(({ className = 'w-4 h-4', size = 16 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const AlertCircleIcon = memo<IconProps>(({ className = 'w-4 h-4', size = 16 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const AlertTriangleIcon = memo<IconProps>(({ className = 'w-4 h-4', size = 16 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// RotateCw Icon - For retry actions
export const RotateCwIcon = memo<IconProps>(({ className = 'w-4 h-4', size = 16 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const XIcon = memo<IconProps>(({ className = 'w-4 h-4', size = 16 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const TrashIcon = memo<IconProps>(({ className = 'w-4 h-4', size = 16 }) => (
  <svg
    className={className}
    width={size}
    height={size}
