...
cat > .env << EOF
VITE_SCALEKIT_CLIENT_ID=${VITE_SCALEKIT_CLIENT_ID}
VITE_SCALEKIT_AUTH_BASE_URL=${VITE_SCALEKIT_AUTH_BASE_URL}
VITE_SCALEKIT_AUTH_AUTHORIZE_PATH=${VITE_SCALEKIT_AUTH_AUTHORIZE_PATH}
VITE_SCALEKIT_AUTH_TOKEN_PATH=${VITE_SCALEKIT_AUTH_TOKEN_PATH}
VITE_SCALEKIT_AUTH_LOGOUT_PATH=${VITE_SCALEKIT_AUTH_LOGOUT_PATH}
VITE_SCALEKIT_REDIRECT_URI=${VITE_SCALEKIT_REDIRECT_URI}
EOF
