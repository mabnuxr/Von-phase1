      ...
      widgets: {
        w_total_arr: {
          ...
          config: {
            ...
            format: ",.0f",
            prefix: "$",
            comparison: { value: 14.2, format: ".1f", suffix: "%", label: "vs last quarter", positive_is_good: true },
        ...
        w_new_bookings: {
          ...
          config: {
            ...
            format: ",.0f",
            prefix: "$",
            comparison: { value: 22.6, format: ".1f", suffix: "%", label: "vs Q3", positive_is_good: true },
              ...
              series: [
                {
                  name: "MRR",
                  data: [
                    1180000, 1220000, 1265000, 1310000, 1355000, 1390000,
                    1420000, 1465000, 1510000, 1540000, 1575000, 1562500,
                  ],
    ...
    dashboard: {
      ...
      widgets: {
        w_header_text: {
          ...
          config: {
            content:
              "Q4 FY2025 Go-To-Market Review — Updated daily from Salesforce sync",
            variant: "subheading",
            alignment: "left",
          },
        },
        w_pipeline_value: {
          ...
          config: {
            ...
            format: ",.0f",
            prefix: "$",
            comparison: { value: 18.3, format: ".1f", suffix: "%", label: "vs last quarter", positive_is_good: true },
        ...
        w_win_rate: {
          ...
          config: {
            ...
            format: ".1f",
            suffix: "%",
            comparison: { value: 3.1, format: ".1f", suffix: "%", label: "vs Q3", positive_is_good: true },
        ...
        w_avg_deal_size: {
          ...
          config: {
            ...
            format: ",.0f",
            prefix: "$",
            comparison: { value: 5.2, format: ".1f", suffix: "%", label: "vs Q3", positive_is_good: true },
        ...
        w_sales_cycle: {
          ...
          config: {
            ...
            format: ",.0f",
            suffix: " days",
            comparison: { value: -5, format: ".0f", suffix: "%", label: "vs Q3 (47 days)", positive_is_good: false },
          },
        },
        w_pipeline_by_stage: {
        ...
        w_rep_leaderboard: {
          ...
          config: {
            ...
            sorting: {
              enabled: true,
              defaultSort: { field: "closedWon", direction: "desc" },
            },
            rowStyles: [
              {
                condition: {
    ...
    dashboard: {
      ...
      widgets: {
        w_text_header: {
          ...
          title: "Header",
          config: {
            content: "FY2025 Sales & GTM Analytics — All Regions, All Segments",
            variant: "heading",
            alignment: "left",
          },
        },
        w_counter_arr: {
          ...
          config: {
            ...
            format: ",.0f",
            prefix: "$",
            comparison: { value: 18.6, format: ".1f", suffix: "%", label: "YoY growth", positive_is_good: true },
        ...
        w_counter_nrr: {
          ...
          config: {
            ...
            format: ".0f",
            suffix: "%",
            comparison: { value: 4, format: ".0f", suffix: "%", label: "vs last year (114%)", positive_is_good: true },
        ...
        w_counter_cac: {
          ...
          config: {
            ...
            format: ",.0f",
            prefix: "$",
            comparison: { value: -8.2, format: ".1f", suffix: "%", label: "vs Q3 ($13,500)", positive_is_good: false },
            target: { value: 10000, format: ",.0f", label: "Target", inverted: true },
          },
        },
        w_counter_churn: {
          id: "w_counter_churn",
          ...
          config: {
            ...
            format: ".1f",
            suffix: "%",
            comparison: { value: 0.8, format: ".1f", suffix: "%", label: "vs Q3 (3.4%)", positive_is_good: false },
            target: { value: 3, format: ".0f", label: "Target", inverted: true },
          },
        },
        w_line_mrr: {
          id: "w_line_mrr",
              ...
              series: [
                {
                  name: "MRR",
                  data: [
                    1680000, 1730000, 1790000, 1840000, 1890000, 1935000,
                    1980000, 2020000, 2050000, 2080000, 2060000, 2066000,
                  ],
        ...
        w_area_pipeline: {
          ...
          subtitle: "Stacked by stage — last 6 months",
          config: {
            chartType: "area",
            highchartsOptions: {
              chart: { type: "area" },
              ...
              series: [
                {
                  name: "Prospecting",
                  data: [2800000, 3100000, 2900000, 3200000, 3400000, 3200000],
                },
                {
                  name: "Discovery",
                  data: [2200000, 2400000, 2600000, 2500000, 2800000, 2850000],
                },
                {
                  name: "Proposal",
                  data: [1800000, 1900000, 2100000, 2300000, 2400000, 2600000],
                },
                {
                  name: "Negotiation",
                  data: [1200000, 1400000, 1500000, 1800000, 2000000, 2150000],
                },
              ],
              plotOptions: {
                area: {
        ...
        w_column_bookings: {
          id: "w_column_bookings",
          type: "chart",
          title: "New Bookings by Quarter",
        ...
        w_bar_rep_perf: {
          id: "w_bar_rep_perf",
          type: "chart",
          title: "Top Reps by Closed-Won Revenue",
          subtitle: "Q4 FY2025 — horizontal bar",
          config: {
            chartType: "bar",
            highchartsOptions: {
              chart: { type: "bar" },
              ...
              series: [
                {
                  name: "Closed-Won",
                  data: [
                    820000, 710000, 485000, 420000, 310000, 285000, 220000,
                  ],
                },
              ],
              plotOptions: {
        ...
        w_pie_revenue_source: {
          id: "w_pie_revenue_source",
          type: "chart",
          title: "Revenue by Source",
          subtitle: "Q4 closed-won attribution",
          config: {
            chartType: "pie",
            highchartsOptions: {
              chart: { type: "pie" },
        ...
        w_donut_deal_stage: {
          id: "w_donut_deal_stage",
          type: "chart",
          title: "Open Deals by Stage",
          subtitle: "Deal count distribution",
          config: {
            chartType: "donut",
            highchartsOptions: {
              chart: { type: "pie" },
              ...
              tooltip: {
                pointFormat:
                  "{point.name}: <b>{point.y} deals</b> ({point.percentage:.1f}%)",
              },
              legend: { enabled: false },
              credits: { enabled: false },
            },
        ...
        w_column_line_dual: {
          id: "w_column_line_dual",
          type: "chart",
          title: "Bookings vs Win Rate",
          subtitle: "Dual axis — column + line",
          config: {
              ...
              series: [
                {
                  name: "Bookings",
                  type: "column",
                  data: [2200000, 2700000, 3100000, 3250000],
                  yAxis: 0,
                },
                {
                  name: "Win Rate",
                  type: "line",
                  data: [26.1, 28.5, 29.3, 32.4],
                  yAxis: 1,
        ...
        w_line_line_multi: {
          id: "w_line_line_multi",
          type: "chart",
          title: "Pipeline Created by Segment",
          subtitle: "Monthly trend — multi-line",
          config: {
            chartType: "line-line",
            highchartsOptions: {
              chart: { type: "line" },
              ...
              series: [
                {
                  name: "Enterprise",
                  data: [1200000, 1350000, 1100000, 1500000, 1400000, 1650000],
                  marker: { symbol: "circle" },
                },
                {
                  name: "Mid-Market",
                  data: [800000, 920000, 880000, 1050000, 1100000, 1020000],
                  marker: { symbol: "diamond" },
                },
                {
                  name: "SMB",
                  data: [450000, 520000, 480000, 600000, 580000, 640000],
        ...
        w_line_bar_combo: {
          id: "w_line_bar_combo",
          type: "chart",
          title: "Outbound Activity vs Meetings Booked",
          subtitle: "Dual axis — bar + line",
          config: {
            chartType: "line-bar",
            highchartsOptions: {
              chart: { type: "bar" },
              ...
              series: [
                {
                  ...
                  type: "bar",
                  data: [4200, 4800, 5100, 3900, 5500, 5800],
                  yAxis: 0,
                },
                {
                  name: "Meetings Booked",
                  type: "line",
                  data: [68, 82, 91, 64, 105, 112],
                  yAxis: 1,
        ...
        w_table_deals: {
          ...
          subtitle: "All open opportunities — sorted by expected close date",
          config: {
            columns: [
              {
                id: "col_deal_name",
              ...
              },
              {
                ...
                format: {
                  colorScale: {
                    type: "threshold",
                    thresholds: [
                      { value: 14, label: "On Track" },
                      { value: 30, label: "Slow" },
                      { value: 999, label: "Stalled" },
                    ],
                  },
                },
              },
              {
                ...
                format: {
                  badge: {
                    mapping: { Enterprise: {}, "Mid-Market": {}, SMB: {} },
                  },
                },
              },
            ],
            ...
            sorting: {
              enabled: true,
              defaultSort: { field: "expectedCloseDate", direction: "asc" },
            },
            rowStyles: [
              {
                condition: { field: "daysInStage", operator: "gt", value: 30 },
                sentiment: "negative",
                style: {},
              },
              {
                condition: { field: "probability", operator: "gte", value: 80 },
                sentiment: "positive",
...
export const gtmRepLeaderboardData: WidgetDataResponse = {
  ...
  data: {
    ...
    meta: {
      fetchedAt: "2025-02-24T14:30:00Z",
      cacheHit: true,
      dataFreshness: "fresh",
    },
  },
...
export function getDashboardFixture(
  dashboardId: string,
): DashboardMetadataResponse | null {
