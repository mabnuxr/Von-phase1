  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 flex-shrink-0 ml-4">
        {/* Status indicator */}
        {isLoading && (
          <span className="text-sm text-von-purple font-medium">
            {loadingText}
          </span>
        )}
        ...
        {onDelete && (
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded transition-colors cursor-pointer border-none bg-transparent"
