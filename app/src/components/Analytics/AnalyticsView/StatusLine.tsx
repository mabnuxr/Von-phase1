...
export const StatusLine: React.FC<StatusLineProps> = ({ state, lastSavedAt, lastRefreshedAt }) => {
  ...
  const refreshedLabel = lastRefreshedAt ? formatRelativeTime(lastRefreshedAt) : null;
  const sameTimestamp =
    !!lastSavedAt &&
    !!lastRefreshedAt &&
